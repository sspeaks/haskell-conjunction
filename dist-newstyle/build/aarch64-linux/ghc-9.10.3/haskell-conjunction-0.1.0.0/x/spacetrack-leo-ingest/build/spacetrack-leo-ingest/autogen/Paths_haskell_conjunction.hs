...
{-|
Module      : Paths_haskell_conjunction
...
-- at runtime using the environment variable haskell_conjunction_bindir.
...
-- environment variable haskell_conjunction_libdir.
...
-- using the environment variable haskell_conjunction_dynlibdir.
...
-- runtime using the environment variable haskell_conjunction_datadir.
...
-- variable haskell_conjunction_libexedir.
...
-- using the environment variable haskell_conjunction_sysconfdir.
...
libdir     = "/home/sspeaks/.cabal/lib/aarch64-linux-ghc-9.10.3-ad82/haskell-conjunction-0.1.0.0-inplace-spacetrack-leo-ingest"
dynlibdir  = "/home/sspeaks/.cabal/lib/aarch64-linux-ghc-9.10.3-ad82"
datadir    = "/home/sspeaks/.cabal/share/aarch64-linux-ghc-9.10.3-ad82/haskell-conjunction-0.1.0.0"
libexecdir = "/home/sspeaks/.cabal/libexec/aarch64-linux-ghc-9.10.3-ad82/haskell-conjunction-0.1.0.0"
sysconfdir = "/home/sspeaks/.cabal/etc"

getBinDir     = catchIO (getEnv "haskell_conjunction_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "haskell_conjunction_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "haskell_conjunction_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "haskell_conjunction_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "haskell_conjunction_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "haskell_conjunction_sysconfdir") (\_ -> return sysconfdir)
